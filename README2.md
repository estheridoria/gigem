...
``` main
# Set your working Directory to someplace visible (e.g. Downloads, Desktop)
setwd("...") 
...
To explore the package capabilities with example data (optional).

1. Open the github page with the Example data at the following link: [Example Data] https://github.com/estheridoria/gigem.Example/blob/main/ExampleAnalysis.zip
2. Click the button with three dots to the right of the title, "gigem.Example
/ExampleAnalysis.zip"
3. Download the zipped file to your computer
4. Unzip the file and run the example analysis
